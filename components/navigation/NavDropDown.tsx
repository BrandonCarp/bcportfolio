  ...
  return (
    <li ref={ref} className="relative group">
      <button
        ...
        className="inline-flex items-center whitespace-nowrap  lg:text-lg"
      >
        {label}
      </button>
      ...
      {/* Dropdown */}
      <div
        className={`absolute top-full left-0  rounded z-50 overflow-hidden transition-all duration-300 ${
